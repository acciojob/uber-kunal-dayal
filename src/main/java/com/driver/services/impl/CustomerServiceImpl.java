...
//
//
//		(TripBooking)tripBookingRepository2.save(newTripBooked);
...
//		TripBooking bookedTrip = (TripBooking)tripBookingRepository2.findById(tripId).get();
//		bookedTrip.setStatus(TripStatus.CANCELED);
//		bookedTrip.setBill(0);
//		bookedTrip.getDriver().getCab().setAvailable(true);
//		(TripBooking)tripBookingRepository2.save(bookedTrip);
//	}
//
//	@Override
